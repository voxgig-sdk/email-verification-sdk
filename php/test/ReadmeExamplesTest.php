...
// EmailVerification SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (EmailVerificationSDK::test)
...
{
    private const SDK_CLASS = 'EmailVerificationSDK';
    ...
    private const SDK_BASE = 'emailverification_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../emailverification_sdk.php';
