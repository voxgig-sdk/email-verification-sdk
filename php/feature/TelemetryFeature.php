...
// EmailVerification SDK telemetry feature
...
class EmailVerificationTelemetryFeature extends EmailVerificationBaseFeature
{
    ...
    private function _close(EmailVerificationContext $ctx, bool $ok): void
    {
