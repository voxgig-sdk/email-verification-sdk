...
// EmailVerification SDK proxy feature
...
class EmailVerificationProxyFeature extends EmailVerificationBaseFeature
{
    ...
    public function init(EmailVerificationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (EmailVerificationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
