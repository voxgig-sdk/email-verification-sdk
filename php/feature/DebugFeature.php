...
// EmailVerification SDK debug feature
...
class EmailVerificationDebugFeature extends EmailVerificationBaseFeature
{
    ...
    private function _finish(EmailVerificationContext $ctx, bool $ok): void
    {
