...
// EmailVerification SDK cache feature
...
class EmailVerificationCacheFeature extends EmailVerificationBaseFeature
{
    ...
    private function _through(EmailVerificationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
