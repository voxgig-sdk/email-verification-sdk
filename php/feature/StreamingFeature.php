...
// EmailVerification SDK streaming feature
...
class EmailVerificationStreamingFeature extends EmailVerificationBaseFeature
{
    ...
    private function _iterate(EmailVerificationResult $result): \Generator
    {
    ...
    private function _streamable(EmailVerificationContext $ctx): bool
    {
