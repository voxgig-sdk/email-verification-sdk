...
// EmailVerification SDK metrics feature
...
class EmailVerificationMetricsFeature extends EmailVerificationBaseFeature
{
    ...
    private function _record(EmailVerificationContext $ctx, bool $ok): void
    {
