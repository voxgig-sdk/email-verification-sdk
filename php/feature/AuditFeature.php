...
// EmailVerification SDK audit feature
...
class EmailVerificationAuditFeature extends EmailVerificationBaseFeature
{
    ...
    private function _emit(EmailVerificationContext $ctx, string $outcome): void
    {
