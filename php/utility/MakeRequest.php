...
// EmailVerification SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class EmailVerificationMakeRequest
{
    public static function call(EmailVerificationContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new EmailVerificationResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new EmailVerificationResponse($fetched);
        } else {
