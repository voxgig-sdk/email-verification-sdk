...
// EmailVerification SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class EmailVerificationTransformResponse
{
    public static function call(EmailVerificationContext $ctx): mixed
    {
        ...
        $transform = EmailVerificationHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
