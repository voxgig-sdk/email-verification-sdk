...
// EmailVerification SDK utility: fetcher

class EmailVerificationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; EmailVerificationSDK/1.0)';
    ...
    public static function call(EmailVerificationContext $ctx, string $fullurl, array $fetchdef): array
    {
