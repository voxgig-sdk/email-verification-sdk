// Command EmailVerification-mcp is an MCP server exposing the EmailVerification
// SDK as MCP tools.
//
// Two tools are registered:
//
//	EmailVerification_list  — list records of an entity
//	EmailVerification_load  — load a single record of an entity
//
