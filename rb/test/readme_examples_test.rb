...
#      offline in seeded test mode (EmailVerificationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "EmailVerification_sdk.rb")
  SDK_CLASS = "EmailVerificationSDK"
  ...
  SDK_BASE = "EmailVerification_sdk"
