# EmailVerification Ruby SDK Reference

Complete API reference for the EmailVerification Ruby SDK.
...
#### `EmailVerificationSDK.test(testopts = nil, sdkopts = nil)`
