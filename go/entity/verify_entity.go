...
type VerifyEntity struct {
	name    string
	client  *core.EmailVerificationSDK
...
func NewVerifyEntity(client *core.EmailVerificationSDK, entopts map[string]any) *VerifyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *VerifyEntity) GetName() string { return e.name }
...
func (e *VerifyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *VerifyEntity) Deleted() bool {
	return e.deleted
}


func (e *VerifyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVerifyEntity(e.client, opts)
}

func (e *VerifyEntity) Data(args ...any) any {
...
func (e *VerifyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Verify; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *VerifyEntity) DataTyped(data ...Verify) Verify {
	if len(data) > 0 {
		return typedFrom[Verify](e.Data(asMap(data[0])))
	}
	return typedFrom[Verify](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Verify (all fields
// optional at the wire level).
func (e *VerifyEntity) MatchTyped(match ...Verify) Verify {
	if len(match) > 0 {
		return typedFrom[Verify](e.Match(asMap(match[0])))
	}
	return typedFrom[Verify](e.Match())
}
...
func (e *VerifyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *VerifyEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// VerifyLoadMatch and returns an Verify. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *VerifyEntity) LoadTyped(reqmatch VerifyLoadMatch, ctrl map[string]any) (Verify, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Verify{}, err
	}
	return typedFrom[Verify](res), nil
}



func (e *VerifyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *VerifyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *VerifyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *VerifyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *VerifyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
