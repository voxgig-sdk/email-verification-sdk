...
func registerSDKWords(r *eng.Registry, client *sdk.EmailVerificationSDK) {
...
func runOp(client *sdk.EmailVerificationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
