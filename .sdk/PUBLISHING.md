...
|---|---|---|
| `ts/` | @voxgig-sdk/email-verification-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/email-verification-sdk \
      --repository voxgig-sdk/email-verification-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/email-verification-sdk` shows it, and
`npm trust revoke @voxgig-sdk/email-verification-sdk --id=<id>` removes it.
