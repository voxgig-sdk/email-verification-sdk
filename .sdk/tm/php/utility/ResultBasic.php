...
// EmailVerification SDK utility: result_basic

class EmailVerificationResultBasic
{
    public static function call(EmailVerificationContext $ctx): ?EmailVerificationResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof EmailVerificationError) ? $result->err->msg : (string)$result->err;
