...
// EmailVerification SDK utility: make_options

class EmailVerificationMakeOptions
{
    ...
    public static function call(EmailVerificationContext $ctx): array
    {
        ...
        //
        // `EmailVerificationSchema::optspec()` is built from the model:
        ...
        $optspec = EmailVerificationSchema::optspec();
