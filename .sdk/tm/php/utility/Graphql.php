...
// EmailVerification SDK utility: graphql
//
...
class EmailVerificationGraphql
{
    ...
    // equivalent.
    public static function body(EmailVerificationContext $ctx): mixed
    {
    ...
    public static function errors(EmailVerificationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
