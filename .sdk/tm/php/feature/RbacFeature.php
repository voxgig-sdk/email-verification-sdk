...
// EmailVerification SDK rbac feature
...
class EmailVerificationRbacFeature extends EmailVerificationBaseFeature
{
    ...
    private function _required(EmailVerificationContext $ctx): ?string
    {
    ...
    private function _reject(EmailVerificationContext $ctx, string $required): void
    {
    ...
    private function _track(EmailVerificationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
