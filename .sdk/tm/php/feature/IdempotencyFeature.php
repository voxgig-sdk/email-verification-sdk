...
// EmailVerification SDK idempotency feature
...
class EmailVerificationIdempotencyFeature extends EmailVerificationBaseFeature
{
    ...
    private function _mutating(EmailVerificationContext $ctx): bool
    {
