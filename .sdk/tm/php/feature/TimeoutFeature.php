...
// EmailVerification SDK timeout feature
...
class EmailVerificationTimeoutFeature extends EmailVerificationBaseFeature
{
    ...
    private function _with_timeout(EmailVerificationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(EmailVerificationContext $_ctx, float $ms): void
    {
        $client = $this->client;
