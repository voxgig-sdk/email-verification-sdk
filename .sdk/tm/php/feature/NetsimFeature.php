...
// EmailVerification SDK netsim feature
...
class EmailVerificationNetsimFeature extends EmailVerificationBaseFeature
{
    ...
    private function _simulate(EmailVerificationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(EmailVerificationContext $ctx, array $applied): void
    {
        $client = $this->client;
