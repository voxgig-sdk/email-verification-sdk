...
// EmailVerification SDK ratelimit feature
...
class EmailVerificationRatelimitFeature extends EmailVerificationBaseFeature
{
    ...
    private function _acquire(EmailVerificationContext $ctx): void
    {
    ...
    private function _track(EmailVerificationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
