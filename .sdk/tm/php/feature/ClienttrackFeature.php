...
// EmailVerification SDK clienttrack feature
...
class EmailVerificationClienttrackFeature extends EmailVerificationBaseFeature
{
    ...
    public function PostConstruct(EmailVerificationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'EmailVerification-SDK';
