...
class EmailVerificationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = EmailVerificationTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = EmailVerificationTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = EmailVerificationTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
