...
from emailverification_sdk.core.control import EmailVerificationControl
...
from emailverification_sdk.core.helpers import get_ctx_prop, to_map
...
class EmailVerificationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = EmailVerificationControl()
        ...
        if isinstance(sp, EmailVerificationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, EmailVerificationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, EmailVerificationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return EmailVerificationOperation({})
    ...
    def make_error(self, code, msg):
        return EmailVerificationError(code, msg, self)
