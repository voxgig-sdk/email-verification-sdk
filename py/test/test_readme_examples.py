# EmailVerification SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions EmailVerificationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both EmailVerificationSDK(...) and EmailVerificationSDK.test(...) become
#      EmailVerificationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "emailverification_sdk"
_SDK_CLASS = "EmailVerificationSDK"
