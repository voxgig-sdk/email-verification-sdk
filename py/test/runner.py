...
class EmailVerificationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = EmailVerificationTestRunner.getenv("EMAIL_VERIFICATION_TEST_LIVE")
        override = EmailVerificationTestRunner.getenv("EMAIL_VERIFICATION_TEST_OVERRIDE")
        ...
        explain = EmailVerificationTestRunner.getenv("EMAIL_VERIFICATION_TEST_EXPLAIN")
