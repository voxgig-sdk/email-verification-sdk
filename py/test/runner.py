...
class EmailVerificationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = EmailVerificationTestRunner.getenv("EMAILVERIFICATION_TEST_LIVE")
        override = EmailVerificationTestRunner.getenv("EMAILVERIFICATION_TEST_OVERRIDE")
        ...
        explain = EmailVerificationTestRunner.getenv("EMAILVERIFICATION_TEST_EXPLAIN")
