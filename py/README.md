# EmailVerification Python SDK



The Python SDK for the EmailVerification API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Verify()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/email-verification-sdk/releases)) or
...
client = EmailVerificationSDK(options)
```
...
```
py/
├── emailverification_sdk.py         -- Main SDK module
