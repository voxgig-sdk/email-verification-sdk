...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.EMAILVERIFICATION_TEST_LIVE ||
    'TRUE' === process.env.EMAILVERIFICATION_TEST_OVERRIDE
  ) {
  ...
  m.EMAILVERIFICATION_TEST_EXPLAIN = process.env.EMAILVERIFICATION_TEST_EXPLAIN || m.EMAILVERIFICATION_TEST_EXPLAIN
