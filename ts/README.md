# EmailVerification TypeScript SDK



The TypeScript SDK for the EmailVerification API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Verify()` — each with a small set of operations (`load`)
...
```ts
new EmailVerificationSDK(options?: {
  base?: string
  prefix?: string
  suffix?: string
...
| `tester(testopts?, sdkopts?)` | `EmailVerificationSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `EmailVerificationSDK.test(testopts?, sdkopts?)` | `EmailVerificationSDK` | Create a test-mode client. |
...
| `client` | `client(): EmailVerificationSDK` | Return the parent SDK client. |
...
email-verification/
├── src/
│   ├── EmailVerificationSDK.ts        # Main SDK class
