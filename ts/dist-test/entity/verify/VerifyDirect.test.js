...
(0, node_test_1.describe)('VerifyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.EmailVerificationSDK({
    ...
    (0, node_test_1.test)('direct-load-verify', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-verify', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.EMAIL_VERIFICATION_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.EmailVerificationSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['EMAIL_VERIFICATION_TEST_VERIFY_ENTID'];
    ...
    const client = new __1.EmailVerificationSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=VerifyDirect.test.js.map