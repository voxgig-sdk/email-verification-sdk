...
function envOverride(m) {
    if ('TRUE' === process.env.EMAIL_VERIFICATION_TEST_LIVE ||
        'TRUE' === process.env.EMAIL_VERIFICATION_TEST_OVERRIDE) {
    ...
    m.EMAIL_VERIFICATION_TEST_EXPLAIN = process.env.EMAIL_VERIFICATION_TEST_EXPLAIN || m.EMAIL_VERIFICATION_TEST_EXPLAIN;
    return m;
}
